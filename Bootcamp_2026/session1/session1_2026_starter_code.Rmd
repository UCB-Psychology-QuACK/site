---
title: "quack_session1_2026 starter code"
...
# after you run this, the variable 'numbers' should pop up in your global environment on the top right
...
names <- c("Sophie", "Nina", "Victoria", "Alyson")
...
# You can also make numeric values into a factor
  ...
  TreatmentGroup <- c(1, 2, 3, 3, 4, 2, 4, 3)
  
  #making it a factor
  TreatmentGroupFactor <- factor(c(1, 2, 3, 3, 4, 2, 4, 3))
```
...
wizard_hat_preferences <- read.csv("Folder 2/Ain't no folder like a folder/You're getting folder/wizard_hat_preferences.csv")
...
data <- read.csv("quack_response_data.csv")
