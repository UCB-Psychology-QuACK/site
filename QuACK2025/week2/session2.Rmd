...
[Modeled after QuACK 2025 Summer Sessions 2 by Nina Schoener and Sophie Regan]
...
# it looks like the Temperature and Pets columns are problematic here, since each has some numeric values and some character values
...
# we can do that using grepl() on the Temperature column
