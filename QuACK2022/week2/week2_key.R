...
getwd()
# "C:/Users/14122/OneDrive/Documents" <- On Elena's computer!
...
# doing this
# penguins <- read.csv("C:/Users/14122/Box/QuACK/quack2022/data/penguins.csv")
# This is the absolute path of the data on Elena's computer

# We don't recommend doing this. Why not?
# - Not good for if the quack2022 folder is moved somewhere else
...
# we share the whole folder (e.g., quack2022), it doesn't matter where the other
...
# So we want our working directory to be wherever quack2022 is located on your
# computer, here represented by ~ for short, and then in the week 2 folder, like
# this, "~/quack2022/week2"
...
# setwd("C:/Users/14122/Box/QuACK/quack2022/week2")

# Option 2: Session > Set Working Directory > To Source File Location
# Does the setwd("C:/Users/14122/Box/QuACK/quack2022/week2") for you!
...
# Lets make the sex column into a factor 
