...
## 2. Remove all rows that have NAs

penguins_noNA <- penguins %>% 
  drop_na()

## 3. We said before that the year column tells you the year that the data were collected. But we haven't mentioned whether these data are cross-sectional or longitudinal. Check whether there are data for 
